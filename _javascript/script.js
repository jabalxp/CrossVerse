...
// nao mexe aqui jao, to vendo aqui ainda
...
function mudarPersonagem() {
    ...
    switch (selecao) {
        ...
        case "sonic":
            ...
            // condicional pra quando soltar a seta pra baixo, ele virar o sonic novamente
...
function iniciarGame() {
    ...
    //Matheus
    //Isso aqui verifica se o display é "none", se for ele ganha pontos e exibe no elemento com id "pontos"
